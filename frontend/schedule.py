...
def update_cafenero_timer(context: CallbackContext) -> None:
    update_cafenero.delay()
def update_personalkantine_timer(context: CallbackContext) -> None:
    update_personalkantine.delay()
def update_en_canteen_timer(context: CallbackContext) -> None:
    update_en_canteen.delay()
def update_singh_timer(context: CallbackContext) -> None:
    update_singh.delay()
def update_all_studierendenwerk_canteens_timer(context: CallbackContext) -> None:
